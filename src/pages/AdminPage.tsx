...
import { IonButton, IonCard, IonCardContent, IonCardHeader, IonCardSubtitle, IonCardTitle, IonContent, IonPage, IonSelect, IonSelectOption } from '@ionic/react';
  ...
  return (
    <IonContent>
      ...
      <IonCard>
        ...
        <IonCardContent>
          <IonSelect onIonChange={(e: any) => setLanguageTable(e.detail.value)} placeholder="Select Language Table">
            <IonSelectOption value="sil_language_codes">Sil Language Codes</IonSelectOption>
            <IonSelectOption value="iso_639_2">ISO</IonSelectOption>
            <IonSelectOption value="glottolog_language">Glottolog</IonSelectOption>
          </IonSelect>
        </IonCardContent>
      </IonCard>
